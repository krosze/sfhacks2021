...
function populateUserValidationDiv(contentDiv){
...
// function populateEmailValidationDiv(contentDiv){
...
function populatePasswordValidationDiv(contentDiv){
...
function populateConfirmPasswordValidationDiv(contentDiv){

}

function showValidationDiv(event){
...
function updateEmailValidation(event){
    
}

function updatePasswordValidation(event){

}

function updateCPasswordValidation(event){
